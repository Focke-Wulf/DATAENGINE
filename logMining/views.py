...
serverdict = { 
            ...
            #'moojnn_school_3_user' : "ssh -p 1122 root@121.40.229.164 'cd /guoyun/apache-tomcat-8.0.24/webapps/logs ; ls|grep mojing-user.log'",
            #'moojnn_school_4_user' : "ssh -p 1122 root@121.40.219.124 'cd /guoyun/apache-tomcat-8.0.24/webapps/logs ; ls|grep mojing-user.log'",
            #'moojnn_school_5_user' : "ssh -p 1122 root@121.40.237.93 'cd /guoyun/apache-tomcat-8.0.24/webapps/logs ; ls|grep mojing-user.log'",
            #'moojnn_school_6_user' : "ssh -p 1122 root@121.43.99.178 'cd /guoyun/apache-tomcat-8.0.24/webapps/logs ; ls|grep mojing-user.log'",
            ...
            'moojnn_school_csp_pro_4_dao' : "ssh root@120.26.101.233 'cd /data/mojingcsp/logs/mojing_csp_log ; ls|grep dao'", # moojnn-csp-pro-4 for School
            'moojnn_school_csp_pro_4_communication' : "ssh root@120.26.101.233 'cd /data/mojingcsp/logs/mojing_csp_log ; ls|grep communication'", # moojnn-csp-pro-4 for School
            ...
            'moojnn_school_csp_pro_3_dao' : "ssh root@120.26.73.36 'cd /data/mojingcsp/logs/mojing_csp_log ; ls|grep dao'", # moojnn-csp-pro-3 for School
            'moojnn_school_csp_pro_3_communication' : "ssh root@120.26.73.36 'cd /data/mojingcsp/logs/mojing_csp_log ; ls|grep communication'", # moojnn-csp-pro-3 for School
...
ssh_dict = {
            ...
            #'moojnn_school_3_user' : "scp -P 1122 root@121.40.229.164:/guoyun/apache-tomcat-8.0.24/webapps/logs/",
            #'moojnn_school_4_user' : "scp -P 1122 root@121.40.219.124:/guoyun/apache-tomcat-8.0.24/webapps/logs/",
            #'moojnn_school_5_user' : "scp -P 1122 root@121.40.237.93:/guoyun/apache-tomcat-8.0.24/webapps/logs/",
            #'moojnn_school_6_user' : "scp -P 1122 root@121.43.99.178:/guoyun/apache-tomcat-8.0.24/webapps/logs/",
            ...
            'moojnn_school_csp_pro_4_dao' : "scp -P 22 root@120.26.101.233:/data/mojingcsp/logs/mojing_csp_log/", # moojnn-csp-pro-4 for School
